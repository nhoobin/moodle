...
";
    ...
    public function get_compose_student_foldername() {
        return array(
            ...
            array('{{username}}_{{groupname}}', '<<><<!@<>#$>>', 'username_!@#$'), # Clean filename strips <>
     ...
     * @param $data
     */
    public function test_decompose_student_foldername($foldername, $data) {
        $this->resetAfterTest(true);

        $assign = $this->create_instance();
        $output = $assign->decompose_student_foldername($foldername);
    ...
    public function get_decompose_student_foldername() {
        return array(
            array('example data_with___afew_____1_assignsubmission_file_', array('1', 'assignsubmission', 'file')),
            array('a few tokens {{and}} !@$!@% in_2_assignsubmission_onlinetext_', array('2', 'assignsubmission', 'onlinetext')),
            array('_participantid_subtype_type_', array('participantid', 'subtype', 'type')),
        );
    }
     ...
     * @param $data
     */
    public function test_decompose_student_foldername_previous($foldername, $data) {
        $this->resetAfterTest(true);
    ...
    public function get_decompose_student_foldername_previous() {
        return array(
            array('Admin User_2_assignsubmission_file_', array('2', 'assignsubmission', 'file')),
            array('Admin User_2_assignsubmission_onlinetext_', array('2', 'assignsubmission', 'onlinetext')),
        );
    }
