...
if ($hassiteconfig or has_any_capability($capabilities, $systemcontext)) { // speedup for non-admins, add all caps used on this page
    ...
    // Allow custom menu in secure view.
    $temp->add(new admin_setting_configcheckbox('allowcustommenuinsecurelayout',
        new lang_string('allowcustommenuinsecurelayout', 'admin'),
        new lang_string('configallowcustommenuinsecurelayout', 'admin'), 0));
    // Show name in secure view.
    $temp->add(new admin_setting_configcheckbox('shownameinsecurelayout',
        new lang_string('shownameinsecurelayout', 'admin'),
        new lang_string('configshownameinsecurelayout', 'admin'), 0));
